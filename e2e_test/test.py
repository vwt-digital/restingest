...
class E2ETest(unittest.TestCase):
    ...
    def test_post_json_no_auth_generic_pos(self):
        ...
        r = requests.post('https://europe-west1-' + self._domain + '.cloudfunctions.net/' + self._domain +
                          '-receive-ingest-func', params=params, json=payload)
    ...
    #     r = requests.post('https://europe-west1-' + self._domain + '.cloudfunctions.net/' + self._domain + '-receive-ingest-func', params=params, json=payload)
    #     try:
